    ...
    paths: {
      ...
      "/v1/unredact": {
        ...
        post: {
          ...
          summary: "Locate leftover bytes / residual. Opaque replace with no leftover refuses SL-UNREDACT-OPAQUE. Never invents letters.",
          requestBody: { required: true, content: { "application/json": { schema: { type: "object", properties: { b64: { type: "string" }, op: { type: "string", enum: ["locate", "lift", "recover", "refuse"] }, query: { type: "string" } }, required: ["b64"] } } } },
...
async function handleRuntime(request, url) {
  ...
  if ((path === "/v1/unredact" || path === "/v1/lift" || path === "/v1/redact-locate") && request.method === "POST") {
    ...
    const result = await unredactFromB64(b64, { op, query: body.query, verb: body.verb });
