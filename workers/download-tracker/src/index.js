...
import { LIMITATION, MODES, TARGETS, VERSION, overlayFromB64, listUnredact, listRecover, UNREDACT_NOTE, RECOVER_NOTE, unredactFromB64, recoverFromB64 } from "./overlay.js";
...
async function handleRuntime(request, url) {
  ...
  if (path.startsWith("/v1/") || path === "/v1") {
    return json({ error: "not found", hint: "GET /v1/health /v1/lenses /v1/targets /v1/unredact /v1/recover /v1/mesh ; POST /v1/overlay /v1/unredact /v1/recover", limitation: LIMITATION }, 404);
  }
  return null;
}
