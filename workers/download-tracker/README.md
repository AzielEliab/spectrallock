...
- Overlay: `POST /v1/overlay` `{b64, mode|lens|lenses, target}` — PNG, max 256 px. Rosetta preview. Live modes include `uv` (ultraviolet aliases) and `candle` (candlelight aliases).
- Setup HTML: `GET /ai`
